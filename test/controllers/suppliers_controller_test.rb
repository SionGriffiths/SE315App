...
class SuppliersControllerTest < ActionController::TestCase
  ...
  #     post :create, supplier: { base_rest_url: @supplier.base_rest_url, name: @supplier.name }
  #   end
  #
  ...
  #   patch :update, id: @supplier, supplier: { base_rest_url: @supplier.base_rest_url, name: @supplier.name }
  #   assert_redirected_to supplier_path(assigns(:supplier))
  # end
  #
